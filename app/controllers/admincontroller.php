...
class AdminController
{
    ...
    private $jazzVenueService;
    private $jazzEventService;
    ...
    public function __construct()
    {
        ...
        $this->jazzVenueService = new JazzVenueService();
    ...
    public function manageFestivals()
    {
        ...
        $artists = $this->jazzArtistService->getAllArtists();
        $venues = $this->jazzVenueService->getAllVenues();
        $events = $this->jazzEventService->getAllEvents();  
        require_once __DIR__ . '/../views/admin/manageallfestival.php';
    }
